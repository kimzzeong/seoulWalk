...
public class CommunityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder instanceof CommunityViewHolder_text){
            ((CommunityViewHolder_text) holder).post_tilte.setText(item.getTitle());
            ...
            ((CommunityViewHolder_image) holder).post_tilte.setText(item.getTitle());
            Glide.with(holder.itemView.getContext()).load(item.getImage()).centerCrop().into(((CommunityViewHolder_image) holder).post_image);
