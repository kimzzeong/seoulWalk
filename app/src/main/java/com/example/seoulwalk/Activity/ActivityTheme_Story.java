...
public class ActivityTheme_Story extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theme_story_recycler.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL,false));

        String Theme_name = "Story";
        ...
        call.enqueue(new Callback<List<DetailCourse_Data>>() {
            ...
            public void onResponse(@NonNull Call<List<DetailCourse_Data>> call, @NonNull Response<List<DetailCourse_Data>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    theme_story_recycler.setAdapter(themeAdapter);
